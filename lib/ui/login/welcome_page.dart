            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.headline6.copyWith(color: ThemeUtils.getMainTextColor(context)),
                ),
                Text(
                ...
                Padding(
                  ...
                  child: HooButton(
                      ...
                      () => Navigator.push(context,
                          PageRouteBuilder(pageBuilder: (ctx, anim, secondAnim) => new FadeTransition(opacity: anim,child: LoginPage(),)))),
                ),
                Padding(
